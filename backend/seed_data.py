...
SEED_USERS = [
    ...
    {"id": "u-isb-student", "email": "vikram.pgp@isb.edu", "password": "Demo@2026",
     ...
     "institution_id": ISB_ID, "avatar_url": None},
    # ISB — extended role coverage
    {"id": "u-isb-progmgr", "email": "meera.pgp@isb.edu", "password": "Demo@2026",
     "name": "Meera Nair", "title": "PGP Programme Manager", "role": "programme_manager",
     "institution_id": ISB_ID, "avatar_url": None},
    {"id": "u-isb-registrar", "email": "raghav.registrar@isb.edu", "password": "Demo@2026",
     "name": "Raghav Pillai", "title": "Registrar · Academic Records", "role": "registrar",
     "institution_id": ISB_ID, "avatar_url": None},
    {"id": "u-isb-career", "email": "priya.careers@isb.edu", "password": "Demo@2026",
     "name": "Priya Sharma", "title": "Career Services Officer", "role": "career_services",
     "institution_id": ISB_ID, "avatar_url": None},
    {"id": "u-isb-compliance", "email": "arjun.compliance@isb.edu", "password": "Demo@2026",
     "name": "Arjun Verma", "title": "Compliance Officer", "role": "compliance_officer",
     "institution_id": ISB_ID, "avatar_url": None},
    {"id": "u-isb-ai-gov", "email": "kavya.aigov@isb.edu", "password": "Demo@2026",
     "name": "Kavya Rao", "title": "AI Governance Admin", "role": "ai_governance_admin",
     "institution_id": ISB_ID, "avatar_url": None},
    # EAIC
    ...
    {"id": "u-eaic-cadet", "email": "saif.cadet@eaic.gov.ae", "password": "Demo@2026",
     ...
     "institution_id": EAIC_ID, "avatar_url": None},
    # EAIC — extended role coverage
    {"id": "u-eaic-training", "email": "hessa.training@eaic.gov.ae", "password": "Demo@2026",
     "name": "Hessa Al Shamsi", "title": "Training Manager", "role": "training_manager",
     "institution_id": EAIC_ID, "avatar_url": None},
    {"id": "u-eaic-hr", "email": "ahmed.workforce@eaic.gov.ae", "password": "Demo@2026",
     "name": "Ahmed Al Mansoori", "title": "HR Workforce Planner", "role": "hr_workforce_planner",
     "institution_id": EAIC_ID, "avatar_url": None},
    {"id": "u-eaic-line", "email": "majid.linemgr@eaic.gov.ae", "password": "Demo@2026",
     "name": "Maj. Majid Al Falasi", "title": "Line Manager · Borders Division", "role": "line_manager",
     "institution_id": EAIC_ID, "avatar_url": None},
    {"id": "u-eaic-compliance", "email": "mariam.compliance@eaic.gov.ae", "password": "Demo@2026",
     "name": "Mariam Al Hosani", "title": "Compliance Officer · AI Governance", "role": "compliance_officer",
     "institution_id": EAIC_ID, "avatar_url": None},
    {"id": "u-eaic-officer", "email": "saeed.officer@eaic.gov.ae", "password": "Demo@2026",
     "name": "Off. Saeed Al Nuaimi", "title": "Senior Officer · Immigration", "role": "instructor",
     "institution_id": EAIC_ID, "avatar_url": None},
    # UoB
